...
function openChannel(msg) {
    ...
    var args = [channel.player, +channel.playerBalance, +channel.bankrollBalance, +channel.nonce, +channel.time, +vrs.v, vrs.r, vrs.s]
    ...
    $.ajax({
        ...
        success: function (d) {
            ...
            options.to = "0xe56bcdc8bd4aa41a559bd62c7267a9289880fd80";
